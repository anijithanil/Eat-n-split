  ...
  return (
    <div className="app">
      <div className="sidebar">
        ...
        {friendbtn && <FormAddFriend addFriends={addFriends}/>}
        {friendbtn && <Button onClick={handleBtn}  >Close</Button>}
        {!friendbtn && <Button onClick={handleBtn}  >Add Friend</Button>}
      </div>
      {selectedFriend && <FormSplitBill handleSplitBill={handleSplitBill} selectedFriend={selectedFriend}/>}
    </div>
  );
}
...
function FriendsList({friends,handleSelection,selectedFriend}){
  ...
  return (
    <ul>
      {friends.map((friend)=>(<Friend  selectedFriend={selectedFriend} handleSelection={handleSelection} friend={friend} key={friend.id} />))}
    </ul>
  )
}
